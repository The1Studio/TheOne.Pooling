...
namespace UniT.Pooling
{
    ...
    public interface IObjectPoolManager
    {
        ...
        public GameObject Spawn(GameObject prefab, Vector3 position = default, Quaternion rotation = default, Transform? parent = null, bool worldPositionStays = true);

        public GameObject Spawn(string key, Vector3 position = default, Quaternion rotation = default, Transform? parent = null, bool worldPositionStays = true);
